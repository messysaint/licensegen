...
public class DESedeKeyGenerator extends Object implements java.io.Serializable {
    ...
    public String generate() {
        ...
        while( true ) {
            try {
                ...
                rvalue = encodeString( dESKeyToStr( desKey ) );                
                break;
    ...
    private static String encodeObject( java.io.Serializable serializableObject, boolean breakLines ) {
        ...
        try {
            ...
            b64os = new DESedeKeyGenerator.OutputStream( baos, DESedeKeyGenerator.ENCODE, breakLines );
    ...
    private static class InputStream extends java.io.FilterInputStream {
        ...
        private InputStream( java.io.InputStream in ) {
            this( in, DESedeKeyGenerator.DECODE );
        }   // end constructor
    ...
    private static class OutputStream extends java.io.FilterOutputStream {
        ...
        private OutputStream( java.io.OutputStream out ) {
            this( out, DESedeKeyGenerator.ENCODE );
        }   // end constructor
